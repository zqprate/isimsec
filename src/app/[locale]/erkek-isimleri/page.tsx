...
export default function BoyNamesPage() {
  ...
  const names = useMemo(() => getNamesByGender("male", locale as Locale), [locale]);
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <ScrollReveal blur>
          <div className="text-center mb-14">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl">{tNav("boyNames")}</h1>
            <p className="mt-4 text-slate-500 text-lg">
              {names.length} {t("boy").toLowerCase()} ismi listeleniyor
            </p>
          </div>
        </ScrollReveal>
